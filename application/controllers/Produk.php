...
class Produk extends CI_Controller{
  ...
  function index()
  {
    ...
    $config['last_tag_open']   = '<li class="disable"><li class="active"><a href="#">';
  ...
  function kategori($slug_kategori)
  {
    ...
    $config['base_url']        = base_url().'produk/kategori/'.$slug_kategori.'/ndex/';
    $config['total_rows']      = $total->total;
    $config['use_page_numbers']= TRUE;
    $config['per_page']        = 6;
